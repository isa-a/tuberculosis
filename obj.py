...
from setup_model import ref, prm, sel, agg, gps_born
...
def geq(t, in_):
    return goveqs_basis2(t, in_, i, s, M, agg, sel, r, p)
...
incd2010 = dsol[t0[:2020] == 2010, i['aux']['inc'][0]] * 1e5

incd2010 = dsol[t0 == 2010, i['aux']['inc'][0]] * 1e5
