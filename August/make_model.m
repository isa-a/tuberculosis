...
m(i.U.ad.migr_rect) = (1-p.LTBIinmigr-prev_in_migr);
...
m(getindsad('Lf_imp','ds')) = p.LTBIinmigr*(1-p.migrTPT)*0.02;
m(getindsad('Ls','ds'))     = p.LTBIinmigr*(1-p.migrTPT)*0.98;
m(getindsad('Pf_imp','ds')) = p.LTBIinmigr*p.migrTPT*0.02;
m(getindsad('Ps','ds'))     = p.LTBIinmigr*p.migrTPT*0.98;
