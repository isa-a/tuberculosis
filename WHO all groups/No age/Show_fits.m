...
% Collate data
alldat = [data.incd2010; data.incd2020; data.mort; data.p_migrTB; data.p_migrpopn; data.p_LTBI; data.notifs];
den = alldat(:,2)';
...
% Set X-axis labels
set(gca, 'XTick', 1:size(alldat,1), 'XTickLabel', {'incd2010', 'incd2020', 'mort', 'p_migrTB', 'p_migrpopn', 'p_LTBI','notifs'});
yl = ylim; yl(1) = 0; ylim(yl);
