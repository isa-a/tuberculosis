...
names = {'beta','betadec','gamma', 'p_relrate','p_relrate_factor', 'r_ART_init','r_HIV_mort','p_HIV_relrate'};      
...
lhd.fn = @(incd2010, incd2020, mort, ART_covg, HIV_prev) f1a(incd2010) + f1b(incd2020) + f2(mort) + ...
