...
m(getindsad('Lf_imp','ds')) = 0.35*(1-p.migrTPT)*0.02;
m(getindsad('Ls','ds'))     = 0.35*(1-p.migrTPT)*0.98;
m(getindsad('Pf_imp','ds')) = 0.35*p.migrTPT*0.02;
m(getindsad('Ps','ds'))     = 0.35*p.migrTPT*0.98;
