...
m(getindsad('Lf_imp','ds')) = p.LTBI_in_migrad*(1-p.migrTPT)*0.02;
m(getindsad('Ls','ds'))     = p.LTBI_in_migrad*(1-p.migrTPT)*0.98;
m(getindsad('Pf_imp','ds')) = p.LTBI_in_migrad*p.migrTPT*0.02;
m(getindsad('Ps','ds'))     = p.LTBI_in_migrad*p.migrTPT*0.98;
