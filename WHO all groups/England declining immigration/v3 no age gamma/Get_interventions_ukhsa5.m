...
for ii = 1:size(xs,1)
    ...
    models = {M0, Mb, Mb_ACFdom, Mb_ACFmig, Mb_TPT, Mb_migTPT, Mb_tx};
    ...
    for mi = 1:length(models)
        if mi == 1 % M0
            ...
            elseif mi == 7
                geq = @(t,in) goveqs_scaleup(t, in, i, s, M0, models{mi}, rin_vec, p0, pb_tx, [2026 2030], agg, prmb_tx, sel, rb_tx, true);
            end
            ...
            if mi >= 3 && any(incsto(7:end, ii, mi) < incsto(7:end, ii, 2))
