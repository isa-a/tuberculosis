...
alldat = [data.incd2010; data.incd2020; data.mort; data.ART_covg; data.HIV_prev];
den = alldat(:,2)';
...
set(gca, 'fontsize', 20, 'XTick', 1:size(alldat,1), 'XTickLabel', {'incd2010', 'incd2020', 'mort', 'ART coverage', 'HIV prevalence'});
