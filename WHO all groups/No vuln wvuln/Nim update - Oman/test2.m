...
for ii = 1:size(xs,1)
    ...
    for mi = 1:length(models)
        ...
        elseif mi >= 8 && mi <= 10  % Mg1, Mg2, Mg3: 2030 to 2033, bifurcating from Mf3
            geq_me = @(t,in) goveqs_scaleup(t, in, i, s, M0, Me, p0, pe, [2024 2027], agg, sel, r0);
            [t1, soln1] = ode15s(geq_me, 2022:2027, init, opts);
            ...
            geq_mg = @(t,in) goveqs_scaleup(t, in, i, s, Mf3, models{mi}, pf3, pg1, [2030 2033], agg, sel, r0);
