...
%     allt   = [t0; t1(2:end)];
    ...
    p_incd_recentinf = incd(5)/incd(1);
    ...
    if incd(1) > 0.1
        ...
        aux.sim        = [incd2010, incd2020, mort, p_migrTB, p_migrpopn, p_LTBI_inmigr, p_vulnpopn, p_vulnTB, incd_ch2020, p_chpopn, p_adpopn, ch_notifs, p_incd_recentinf];
    else
        out = -Inf;
        aux = NaN;
        msg = 1;
