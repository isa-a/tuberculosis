...
names = {'beta','reldec','gamma','p_relrate_gamma_chvad','p_LTBI_in_migrad','p_relLTBI_inmigr_advch','r_vuln_sc','relbeta_vuln', 'p_relrate', 'r_ageing_sc', 'p_relrate_factor'};      
lgths =      [1,        1,      2,                      1,                 1,                       1,       1,             1,           2,        1,                  1];
