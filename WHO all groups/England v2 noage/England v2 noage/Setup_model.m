...
names = {'beta','betadec','gamma','p_LTBI_in_migrad','r_vuln_sc','relbeta_vuln', 'p_relrate'};      
lgths =      [1,        1,      2,                 1,          1,             1,           2];
...
lhd.fn = @(incd2010, incd2020, mort, p_migrTB, p_LTBI_inmigr, p_vulnpopn, p_vulnTB) ... 
    f1a(incd2010) + f1b(incd2020) + f2(mort) + f3(p_migrTB) + f5(p_LTBI_inmigr) + ...
    f6(p_vulnpopn) + f7(p_vulnTB);
