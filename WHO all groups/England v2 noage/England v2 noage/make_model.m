...
m(getinds('Lf_imp','ds')) = p.LTBI_in_migrch*(1-p.migrTPT)*0.02;
m(getinds('Ls','ds'))     = p.LTBI_in_migrch*(1-p.migrTPT)*0.98;
m(getinds('Pf_imp','ds')) = p.LTBI_in_migrch*p.migrTPT*0.02;
m(getinds('Ps','ds'))     = p.LTBI_in_migrch*p.migrTPT*0.98;


%%% Earlier version, with age
...
%%% Earlier version, with age and RR
