...
lhd.fn = @(incd2010, incdRR2020, mort, p_migrTB, p_migrpopn, p_LTBI, p_vulnpopn, p_vulnTB, incd_ch2020, p_chpopn, p_adpopn, ch_notifs) f1a(incd2010) + f1c(incdRR2020) + f2(mort) + ...
                                                                                                     f3(p_migrTB) + f4(p_migrpopn) + f5(p_LTBI) + ...
                                                                                                     f6(p_vulnpopn) + f7(p_vulnTB) + ...
                                                                                                     f8(incd_ch2020) + f10(p_chpopn) + f11(p_adpopn) + f12(ch_notifs);
