...
% lgths =      [1,        1,      2,             1,          1,       1,               1];
names = {'beta','relbeta_RR','betadec','gamma','p_relrate','r_migr','p_LTBI_in_migr','p_RR_in_migr','r_vuln','relbeta_vuln', 'ageing', 'ch_mort', 'p_relrate_factor'};      
lgths =      [1,           1,        1,      2,          2,       1,               1,             1,       1,             1,       1,         1,                1];
