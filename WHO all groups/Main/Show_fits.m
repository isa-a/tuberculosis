...
% Collate data
alldat = [data.incd2010; data.incd2020; data.incdRR2020; data.mort; data.p_migrTB; data.p_migrpopn; data.p_LTBI; data.p_vulnpopn; data.p_vulnTB; data.p_chpopn; data.p_adpopn; data.ch_notifs];
den = alldat(:,2)';
