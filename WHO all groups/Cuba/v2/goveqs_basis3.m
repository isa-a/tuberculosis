...
% Indices for NO RR with HIV lambda entries
% 1. ch dom  ds neg
% 2. ch dom  ds pos
% 3. ch dom  ds art
% 4. ad dom  ds neg
...
allmat = M.lin + ...
        lam(1)*M.nlin.ch.dom.ds.neg           + lam(1)*M.nlin.ch.dom.ds.pos + ...
        lam(1)*M.nlin.ch.dom.ds.art              + lam(2)*M.nlin.ad.dom.ds.neg + ...
        lam(2)*M.nlin.ad.dom.ds.pos          + lam(2)*M.nlin.ad.dom.ds.art + ...
        lam(3)*M.nlin.ch.vuln.ds.neg           + lam(3)*M.nlin.ch.vuln.ds.pos + ...
        lam(3)*M.nlin.ch.vuln.ds.art           +  lam(4)*M.nlin.ad.vuln.ds.neg + ...
        lam(4)*M.nlin.ad.vuln.ds.pos          + lam(4)*M.nlin.ad.vuln.ds.art;
