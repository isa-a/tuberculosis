...
alldat = [data.incd2010; data.incd2020; data.mort; data.p_vulnpopn; data.p_vulnTB; data.propincd_ch; data.p_chpopn; data.p_adpopn; data.ch_notifs; data.HIVincdpeak; data.HIVincdnow; data.incdTBHIV; data.ARTcov];
den = alldat(:,2)';
