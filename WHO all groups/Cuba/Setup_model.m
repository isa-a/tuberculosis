...
f13  = get_distribution_fns(data.incdTBHIV, 'lognorm', show);
...
lhd.fn = @(incd2010, incd2020, mort, p_migrTB, p_LTBI_inmigr, p_vulnpopn, p_vulnTB, p_chpopn, ch_notifs, incdTBHIV) f1a(incd2010) + f1b(incd2020) + ...
